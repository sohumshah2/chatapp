  ...
  */
  ...
  return (
    <div className="ChatApp">
      <div className="head">
        <h1>
          E2Elevate: Elevate your conversations with end to end encryption
        </h1>
      </div>
      <div className="body">
                ...
                <tbody>
                  {messages.map((message, index) => (
                    <tr key={index}>
                      ...
                      <td className="messagesTableTd">
                        <div className="tableElement">{message.time}</div>
                      </td>
                      {/* <td className="messagesTableTd">
  ...
  ></span> */}
        ...
        <div className="Config">
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            ></input>
            <button className="button" onClick={handleSubmitAddressBook}>
              Submit address book
            </button>
          </div>
          <div style={{ display: "flex", alignItems: "center" }}>
